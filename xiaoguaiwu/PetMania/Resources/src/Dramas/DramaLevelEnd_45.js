...
cc.DramaLevelEnd_45 = cc.IDrama.extend({
...
//        this.m_Boy = cc.Sprite.create(Resource.boy_talk_png);
        ...
        var boyStart = cc.p(position.x+size.width/2,position.y-size.height*0.05);
...
//        this.m_Monster = cc.Sprite.create(Resource.cutemonster_png);
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        this.m_BoyContent.push(Resource.ChineseTxt[14]);
        this.m_BoyContent.push(Resource.ChineseTxt[16]);
        this.m_MonsterContent.push(Resource.ChineseTxt[15]);
                    ...
                    self.m_Monster.runAction(cc.Sequence.create(
                        ...
                        cc.CallFunc.create(
                            function ()
                            {
                                ...
                                self.talk(monsterPos,Resource.ChineseTxt[13],false);
                            }
                        )
                    ))
                })
            ...
            if (self.m_Talk_boy)
            {
                ...
                if (!self.m_Boy.isVisible())
                {
                    ...
                    self.m_Boy.runAction(cc.Sequence.create(
                        cc.MoveTo.create(Defines.FPS*15,cc.p(position.x+50,boyStart.y)),
                        cc.MoveTo.create(Defines.FPS*3,cc.p(position.x,boyStart.y)),
                        cc.CallFunc.create(
                            function ()
                            {
                                ...
                                self.talk(position,nextContent,true);
                                return this;
                            }
                        )
                    ));
...
cc.DramaLevelEnd_45.create = function()
{
    var newCreate = new cc.DramaLevelEnd_45();
    if (newCreate)
    {
        newCreate.init();
    }
...
cc.DramaLevelEnd_45.description = function()
{
    return "DramaLevelEnd_45";
};
