...
cc.DramaLevelStart_46 = cc.IDrama.extend({
...
//        this.m_Monster = cc.Sprite.create(Resource.cutemonster_png);
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        this.m_BoyContent.push(Resource.ChineseTxt[29]);
        this.m_MonsterContent.push(Resource.ChineseTxt[28]);
        this.m_Talk_boy = false;
        ...
        var sq = cc.Sequence.create(
            ...
            cc.MoveTo.create(Defines.FPS*15,cc.p(boyEnd.x+50 * Defines.BASE_SCALE,boyEnd.y)),
            ...
            cc.CallFunc.create(
                function(sender)
                {
                    ...
                    self.talk(cc.p(boyEnd.x+size.width,boyEnd.y+size.height/2)/*position*/,Resource.ChineseTxt[27],true);
                })
        );
            ...
            if (self.m_Talk_boy)
            {
                ...
                if (!self.m_Boy.isVisible())
                {
                    ...
                    self.m_Boy.runAction(cc.Sequence.create(
                        cc.MoveTo.create(Defines.FPS*15,cc.p(boyEnd.x+50,boyStart.y)),
                        cc.MoveTo.create(Defines.FPS*3,boyEnd),
                        cc.CallFunc.create(
                            function ()
                            {
                                ...
                                self.talk(cc.p(boyEnd.x+size.width,boyEnd.y+size.height/2)/*position*/,nextContent,true);
                                return this;
                            }
                        )
                    ));
...
cc.DramaLevelStart_46.create = function()
{
    var newCreate = new cc.DramaLevelStart_46();
    if (newCreate)
    {
        newCreate.init();
    }
...
cc.DramaLevelStart_46.description = function()
{
    return "DramaLevelStart_46";
};
