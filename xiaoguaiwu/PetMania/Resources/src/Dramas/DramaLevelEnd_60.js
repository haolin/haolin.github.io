...
cc.DramaLevelEnd_60 = cc.IDrama.extend({
...
//        this.m_Monster = cc.Sprite.create(Resource.cutemonster_png);
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        this.m_BoyContent.push(Resource.ChineseTxt[19]);
        this.m_MonsterContent.push(Resource.ChineseTxt[18]);
        this.m_Talk_boy = false;
        ...
        var sq = cc.Sequence.create(
            ...
            cc.CallFunc.create(
                function(sender)
                {
                    ...
                    self.talk(cc.p(boyEnd.x+size.width,boyEnd.y+size.height/2),Resource.ChineseTxt[17],true);
                })
        );
...
cc.DramaLevelEnd_60.create = function()
{
    var newCreate = new cc.DramaLevelEnd_60();
    if (newCreate)
    {
        newCreate.init();
    }
...
cc.DramaLevelEnd_60.description = function()
{
    return "DramaLevelEnd_60";
};
