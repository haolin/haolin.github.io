...
cc.DramaLevelEnd_125 = cc.IDrama.extend({
...
//        this.m_Monster = cc.Sprite.create(Resource.cutemonster_png);
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        this.m_BoyContent.push(Resource.ChineseTxt[255]);
        this.m_MonsterContent.push(Resource.ChineseTxt[254]);
        this.m_Talk_boy = false;
        ...
        var sq = cc.Sequence.create(
            ...
            cc.CallFunc.create(
                function(sender)
                {
                    ...
                    self.talk(cc.p(boyEnd.x+size.width,boyEnd.y+size.height/2),Resource.ChineseTxt[253],true);
                })
        );
...
cc.DramaLevelEnd_125.create = function()
{
    var newCreate = new cc.DramaLevelEnd_125();
    if (newCreate)
    {
        newCreate.init();
    }
...
cc.DramaLevelEnd_125.description = function()
{
    return "DramaLevelEnd_125";
};
