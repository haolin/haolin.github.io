...
cc.DramaLevelStart_61 = cc.IDrama.extend({
...
//        this.m_Monster = cc.Sprite.create(Resource.cutemonster_png);
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        this.m_BoyContent.push(Resource.ChineseTxt[236]);
        this.m_BoyContent.push(Resource.ChineseTxt[238]);
        this.m_MonsterContent.push(Resource.ChineseTxt[237]);
                    ...
                    self.m_Monster.runAction(cc.Sequence.create(
                        ...
                        cc.CallFunc.create(
                            function ()
                            {
                                ...
                                self.talk(monsterPos,Resource.ChineseTxt[235],false);
                            }
                        )
                    ))
                })
...
cc.DramaLevelStart_61.create = function()
{
    var newCreate = new cc.DramaLevelStart_61();
    if (newCreate)
    {
        newCreate.init();
    }
...
cc.DramaLevelStart_61.description = function()
{
    return "DramaLevelStart_61";
};
