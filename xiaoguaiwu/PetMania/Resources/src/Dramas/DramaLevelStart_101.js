...
cc.DramaLevelStart_101 = cc.IDrama.extend({
...
//        this.m_Monster = cc.Sprite.create(Resource.cutemonster_png);
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        this.m_BoyContent.push(Resource.ChineseTxt[250]);
        this.m_BoyContent.push(Resource.ChineseTxt[252]);
        this.m_MonsterContent.push(Resource.ChineseTxt[251]);
                    ...
                    self.m_Monster.runAction(cc.Sequence.create(
                        ...
                        cc.CallFunc.create(
                            function ()
                            {
                                ...
                                self.talk(monsterPos,Resource.ChineseTxt[249],false);
                            }
                        )
                    ))
                })
...
cc.DramaLevelStart_101.create = function()
{
    var newCreate = new cc.DramaLevelStart_101();
    if (newCreate)
    {
        newCreate.init();
    }
...
cc.DramaLevelStart_101.description = function()
{
    return "DramaLevelStart_101";
};
