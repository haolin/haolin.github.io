...
cc.DramaLevelStart_81 = cc.IDrama.extend({
...
//        this.m_Monster = cc.Sprite.create(Resource.cutemonster_png);
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        this.m_BoyContent.push(Resource.ChineseTxt[243]);
        this.m_BoyContent.push(Resource.ChineseTxt[245]);
        this.m_MonsterContent.push(Resource.ChineseTxt[244]);
                    ...
                    self.m_Monster.runAction(cc.Sequence.create(
                        ...
                        cc.CallFunc.create(
                            function ()
                            {
                                ...
                                self.talk(monsterPos,Resource.ChineseTxt[242],false);
                            }
                        )
                    ))
                })
...
cc.DramaLevelStart_81.create = function()
{
    var newCreate = new cc.DramaLevelStart_81();
    if (newCreate)
    {
        newCreate.init();
    }
...
cc.DramaLevelStart_81.description = function()
{
    return "DramaLevelStart_81";
};
