...
cc.DramaLevelStart_31 = cc.IDrama.extend({
...
//        this.m_Monster = cc.Sprite.create(Resource.cutemonster_png);
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        this.m_BoyContent.push(Resource.ChineseTxt[26]);
        this.m_MonsterContent.push(Resource.ChineseTxt[25]);
        this.m_Talk_boy = false;
        ...
        var sq = cc.Sequence.create(
            ...
            cc.CallFunc.create(
                function(sender)
                {
                    ...
                    self.talk(cc.p(boyEnd.x+size.width,boyEnd.y+size.height/2)/*position*/,Resource.ChineseTxt[24],true);
                })
        );
...
cc.DramaLevelStart_31.create = function()
{
    var newCreate = new cc.DramaLevelStart_31();
    if (newCreate)
    {
        newCreate.init();
    }
...
cc.DramaLevelStart_31.description = function()
{
    return "DramaLevelStart_31";
};
