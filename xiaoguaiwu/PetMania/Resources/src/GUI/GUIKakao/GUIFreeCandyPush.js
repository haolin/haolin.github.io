/**
 * Created by shui liu on 2014/7/8.
 */


//======================================================================================================================
cc.GUIFreeCandyPush = cc.GUIPopupWindow.extend ({
    ...
    ctor: function ()
    {
        ...
        this.m_NeverShow = cc.GameDataBoolean.create("m_FreeCandyNeverShow",false,_DB_OP_GAME);
        this.m_NeverShowTime = cc.GameDataTime.create("m_FreeCandyNeverShowDate",0,_DB_OP_GAME);
    ...
    addContent: function()
    {
        ...
        this.m_buttonNeverShowNor.setVisible(bShowFreeCandyPush);
        ...
        this.m_buttonNeverShowSel.setVisible(!bShowFreeCandyPush);
        ...
        var spriteItemIcons = cc.Sprite.createWithSpriteFrameName("freeCandy_sprite_item_icons.png");
        ...
        cc.log("bShowFreeCandyPush: " + GUI.SHOP_DATA.SHOP_DATA_FREE_CANDY[0].TOTAL_PRICE.toString());
        var numberPrice = GUI.createNumberLabel(GUI.SHOP_DATA.SHOP_DATA_FREE_CANDY[0].TOTAL_PRICE.get().toString(),_GUIPath + "Num/num_2_20x24.png",20,24,".");
        ...
        var spriteMoney = cc.Sprite.createWithSpriteFrameName("general_diamond_2.png");
...
//        bShowFailedItemPush = true;
    ...
    _btnBuy: function()
    {
        ...
        var m_ShopData = GUI.SHOP_DATA.SHOP_DATA_FREE_CANDY[0];
        var needDiamond = m_ShopData.TOTAL_PRICE.get();
        var myScene = cc.Director.getInstance().getRunningScene();

        if (cc.DataMng.getInstance().canSpendMoney(needDiamond))
        {
            cc.GUIBuyPrompt.getInstance().openWindow(_GUILayer(), m_ShopData);
        }
        else
        {
...
//======================================================================================================================
cc.GUIFreeCandyPush._instance = null;
cc.GUIFreeCandyPush.getInstance = function()
{
    if (!this._instance)
    {
        this._instance = new cc.GUIFreeCandyPush();
        this._instance.init();
    }
