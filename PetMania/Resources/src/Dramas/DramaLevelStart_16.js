...
cc.DramaLevelStart_16 = cc.IDrama.extend({
...
//        this.m_Monster = cc.Sprite.create(Resource.cutemonster_png);
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        this.m_BoyContent.push(Resource.ChineseTxt[21]);
        this.m_BoyContent.push(Resource.ChineseTxt[23]);
        this.m_MonsterContent.push(Resource.ChineseTxt[22]);
                    ...
                    self.m_Monster.runAction(cc.Sequence.create(
                        ...
                        cc.CallFunc.create(
                            function ()
                            {
                                ...
                                self.talk(monsterPos,Resource.ChineseTxt[20],false);
                            }
                        )
                    ))
                })
...
cc.DramaLevelStart_16.create = function()
{
    var newCreate = new cc.DramaLevelStart_16();
    if (newCreate)
    {
        newCreate.init();
    }
...
cc.DramaLevelStart_16.description = function()
{
    return "DramaLevelStart_16";
};
