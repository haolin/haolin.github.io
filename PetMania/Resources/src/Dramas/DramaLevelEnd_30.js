...
cc.DramaLevelEnd_30 = cc.IDrama.extend({
...
//        this.m_Monster = cc.Sprite.create(Resource.cutemonster_png);
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        this.m_BoyContent.push(Resource.ChineseTxt[10]);
        this.m_BoyContent.push(Resource.ChineseTxt[12]);
        this.m_MonsterContent.push(Resource.ChineseTxt[11]);
                    ...
                    self.m_Monster.runAction(cc.Sequence.create(
                        ...
                        cc.CallFunc.create(
                            function ()
                            {
                                ...
                                self.talk(monsterPos,Resource.ChineseTxt[9],false);
                            }
                        )
                    ));
                })
...
cc.DramaLevelEnd_30.create = function()
{
    var newCreate = new cc.DramaLevelEnd_30();
    if (newCreate)
    {
        newCreate.init();
    }
...
cc.DramaLevelEnd_30.description = function()
{
    return "DramaLevelEnd_30";
};
