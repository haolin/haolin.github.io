...
cc.DramaLevelEnd_100 = cc.IDrama.extend({
...
//        this.m_Monster = cc.Sprite.create(Resource.cutemonster_png);
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        this.m_BoyContent.push(Resource.ChineseTxt[247]);
        this.m_MonsterContent.push(Resource.ChineseTxt[248]);
        this.m_Talk_boy = true;
                    ...
                    self.m_Monster.runAction(cc.Sequence.create(
                        ...
                        cc.CallFunc.create(
                            function ()
                            {
                                ...
                                self.talk(monsterPos,Resource.ChineseTxt[246],false);
                            }
                        )
                    ))
                })
...
cc.DramaLevelEnd_100.create = function()
{
    var newCreate = new cc.DramaLevelEnd_100();
    if (newCreate)
    {
        newCreate.init();
    }
...
cc.DramaLevelEnd_100.description = function()
{
    return "DramaLevelEnd_100";
};
