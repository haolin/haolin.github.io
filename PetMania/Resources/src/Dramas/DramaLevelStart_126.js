...
cc.DramaLevelStart_126 = cc.IDrama.extend({
...
//        this.m_Monster = cc.Sprite.create(Resource.cutemonster_png);
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        this.m_BoyContent.push(Resource.ChineseTxt[258]);
        this.m_MonsterContent.push(Resource.ChineseTxt[257]);
        this.m_Talk_boy = false;
        ...
        var sq = cc.Sequence.create(
            ...
            cc.CallFunc.create(
                function(sender)
                {
                    ...
                    self.talk(cc.p(boyEnd.x+size.width,boyEnd.y+size.height/2),Resource.ChineseTxt[256],true);
                })
        );
...
cc.DramaLevelStart_126.create = function()
{
    var newCreate = new cc.DramaLevelStart_126();
    if (newCreate)
    {
        newCreate.init();
    }
...
cc.DramaLevelStart_126.description = function()
{
    return "DramaLevelStart_126";
};
