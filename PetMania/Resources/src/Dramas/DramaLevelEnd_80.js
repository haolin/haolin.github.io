...
cc.DramaLevelEnd_80 = cc.IDrama.extend({
...
//        this.m_Monster = cc.Sprite.create(Resource.cutemonster_png);
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        this.m_BoyContent.push(Resource.ChineseTxt[241]);
        this.m_MonsterContent.push(Resource.ChineseTxt[240]);
        this.m_Talk_boy = false;
        ...
        var sq = cc.Sequence.create(
            ...
            cc.CallFunc.create(
                function(sender)
                {
                    ...
                    self.talk(cc.p(boyEnd.x+size.width,boyEnd.y+size.height/2),Resource.ChineseTxt[239],true);
                })
        );
...
cc.DramaLevelEnd_80.create = function()
{
    var newCreate = new cc.DramaLevelEnd_80();
    if (newCreate)
    {
        newCreate.init();
    }
...
cc.DramaLevelEnd_80.description = function()
{
    return "DramaLevelEnd_80";
};
