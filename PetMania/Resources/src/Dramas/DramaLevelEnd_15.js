...
cc.DramaLevelEnd_15 = cc.IDrama.extend({
...
//        this.m_Monster = cc.Sprite.create(Resource.cutemonster_png);
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        this.m_BoyContent.push(Resource.ChineseTxt[8]);
        this.m_MonsterContent.push(Resource.ChineseTxt[7]);
        this.m_Number = this.m_BoyContent.length + this.m_MonsterContent.length + 1;
        this.m_Talk_boy = false;
        ...
        var sq = cc.Sequence.create(
            ...
            cc.CallFunc.create(
                function(sender)
                {
                    ...
                    self.talk(cc.p(boyEnd.x+size.width,boyEnd.y+size.height/2),Resource.ChineseTxt[6],true);
                })
        );
...
//			cc.Scale9Sprite.createWithSpriteFrameName("Images_talk_panel.png",
////                cc.rect(0,0,talkPanelSize.width,talkPanelSize.height),
////                cc.rect(70,80,190,130));
//                cc.rect(talkPanelSize.width*0.3,talkPanelSize.height*0.3,talkPanelSize.width*0.4,talkPanelSize.height*0.4));

//            this.m_MonsterPanel.setPreferredSize(targetSize);
...
//            this.m_BoyPanel = cc.Scale9Sprite.createWithSpriteFrameName("Images_talk_panel.png",
////                cc.rect(0,0,talkPanelSize.width,talkPanelSize.height),
////                cc.rect(70,80,190,130));
//                cc.rect(talkPanelSize.width*0.3,talkPanelSize.height*0.3,talkPanelSize.width*0.4,talkPanelSize.height*0.4));
//
//            this.m_BoyPanel.setPreferredSize(targetSize);
...
cc.DramaLevelEnd_15.create = function()
{
    var newCreate = new cc.DramaLevelEnd_15();
    if (newCreate)
    {
        newCreate.init();
    }
...
cc.DramaLevelEnd_15.description = function()
{
    return "DramaLevelEnd_15";
};
