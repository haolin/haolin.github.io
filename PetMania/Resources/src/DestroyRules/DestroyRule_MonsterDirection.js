//4消 条纹糖 ObjNormalSuperA 的销毁规则

//======================================================================================================================
cc.DestroyRule_MonsterDirection = cc.DestroyRule_MonsterBase.extend({
    ...
    createCommand: function()
    {
        ...
        return cc.Cmd_DesByDirection.create(this.getSrcObj(), this.getObjects());
    },
    ...
    suppose: function()
    {
        ...
        allDirections.forEach(
            function(dir)
            {
                ...
                if (hisObj instanceof cc.Obj_MonsterDirection)
                {
...
//工厂方法
cc.DestroyRule_MonsterDirection.create = function(srcObject)
{
    return new cc.DestroyRule_MonsterDirection(srcObject);
};
