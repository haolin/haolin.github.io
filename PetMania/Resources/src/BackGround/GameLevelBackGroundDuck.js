cc.GameLevelBackGroundDuck = cc.IBackGround.extend({
    ...
    release: function()
    {
        ...
        if (this._displayIOSFlag)
        {
            ...
            cc.ResourceMng.getInstance().removeFromCache(
                _ImagesPath + "background_3.plist",
                _ImagesPath + "background_3.pvr.ccz"
            );
        }
    ...
    {
        return _ImagesPath + "background_3.jpg";
    },
    ...
    displayIOS: function(_backGroundLayer)
    {
        ...
        //创建
        var mainBack = cc.Sprite.createWithSpriteFrameName("background_3.png");
        _backGroundLayer.addChild(mainBack);
        mainBack.setAnchorPoint(cc.p(0, 0));
        ...
        //Cache不要了
        cc.ResourceMng.getInstance().removeTextureCache(_ImagesPath + "background_3.pvr.ccz");
...
cc.GameLevelBackGroundDuck.create = function()
{
    return new cc.GameLevelBackGroundDuck();
};
