cc.GameLevelBackGroundBacterium = cc.IBackGround.extend({
    ...
    release: function()
    {
        ...
        if (this._displayIOSFlag)
        {
            ...
            cc.ResourceMng.getInstance().removeFromCache(
                _ImagesPath + "background_8.plist",
                _ImagesPath + "background_8.pvr.ccz"
            );
    ...
    {
        return _ImagesPath + "background_8.jpg";
    },
    ...
    displayIOS: function(_backGroundLayer)
    {
        ...
        cc.log("GameLevelBackGroundBacterium displayIOS");
        ...
        //创建
        var mainBack = cc.Sprite.createWithSpriteFrameName("background_8.jpg");
        _backGroundLayer.addChild(mainBack);
        GUI.backGroundScaleToScreen(mainBack);
        mainBack.setAnchorPoint(cc.p(0, 0));

        //Cache不要了
        cc.ResourceMng.getInstance().removeTextureCache(_ImagesPath + "background_8.pvr.ccz");
...
cc.GameLevelBackGroundBacterium.create = function()
{
    return new cc.GameLevelBackGroundBacterium();
};
