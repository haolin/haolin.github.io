cc.GameLevelBackGroundGold = cc.IBackGround.extend({
    ...
    release: function()
    {
        ...
        if (this._displayIOSFlag)
        {
            ...
            cc.ResourceMng.getInstance().removeFromCache(
                _ImagesPath + "background_4.plist",
                _ImagesPath + "background_4.pvr.ccz"
            );
    ...
    {
        return _ImagesPath + "background_4.jpg";
    },
    ...
    displayIOS: function(_backGroundLayer)
    {
        ...
        //创建
        var mainBack = cc.Sprite.createWithSpriteFrameName("background_4.png");
        _backGroundLayer.addChild(mainBack);
        GUI.backGroundScaleToScreen(mainBack);
        mainBack.setAnchorPoint(cc.p(0, 0));

        //Cache不要了
        cc.ResourceMng.getInstance().removeTextureCache(_ImagesPath + "background_4.pvr.ccz");
...
cc.GameLevelBackGroundGold.create = function()
{
    return new cc.GameLevelBackGroundGold();
};
