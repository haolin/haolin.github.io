...
cc.GameLevelBackGround_11 = cc.IBackGround.extend({

    //------------------------------------------------------------------------------------------------------------------
    ctor: function()
    {
        this._super();
        cc.log("GameLevelBackGround_11 ctor");
    },
    ...
    release: function()
    {
        ...
        if (this._displayIOSFlag)
        {
            ...
            cc.ResourceMng.getInstance().removeFromCache(
                    _ImagesPath + "background_11.plist",
                    _ImagesPath + "background_11.pvr.ccz"
            );
    ...
    {
        return _ImagesPath + "background_11.jpg";
    },
    ...
    displayIOS: function(_backGroundLayer)
    {
        ...
        cc.log("GameLevelBackGround_11 displayIOS");
        ...
        //创建
        var mainBack = cc.Sprite.createWithSpriteFrameName("background_11.jpg");
        _backGroundLayer.addChild(mainBack);
        GUI.backGroundScaleToScreen(mainBack);
        mainBack.setAnchorPoint(cc.p(0, 0));

        //Cache不要了
        cc.ResourceMng.getInstance().removeTextureCache(_ImagesPath + "background_11.pvr.ccz");
...
cc.GameLevelBackGround_11.create = function()
{
    return new cc.GameLevelBackGround_11();
};
